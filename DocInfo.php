...
<div class="col">
<h1 style="color:green;">    Doctor's Information Form Form</h1>


<form action="4thAttempt.php" method="post"> 
...
Registrar Id:<br>
 <input type="text" name="Registrar_id" value=""><br>
  ...
  <div class="name">
   ...
   <div class="col"><input type="text" class = "form-control" placeholder = "Date Of Birth (DD/MM/YYY)" name="Birth_date"></div>
  <br>
   
  <div class="col"><input type="text" class = "form-control" placeholder = "Date Of Appointment (DD/MM/YYY)"  name="Appointment_date"></div>

<div class="col"><input type="text" class = "form-control" placeholder = "Specialization "  name="Specialization"></div>
...
<table>
  ...
  <tr>
    <td>3.</td>
    <td><input type="text" class = "form-control" placeholder = "MBBS" name="MBBS"></td>
...
<select name="Membership" multiple>

  <option value="bma">BMA</option>
  <option value="british medical society">British medical society</option>
  <option value="american medical society">American medical society</option>
