...
$Bed_No_type_rent_Status = $_POST['Bed_No_1'] ."_".  $_POST['Bed_type_1']  ."_". $_POST['Rent_1'] ." _". $_POST['Status_1'] ." ,".
                      ...
                      $_POST['Bed_No_2'] ."_".  $_POST['Bed_type_2']  ."_". $_POST['Rent_2'] ." _". $_POST['Status_2'] ." ,".
                       ...
                       $_POST['Bed_No_3'] ."_".  $_POST['Bed_type_3']  ."_". $_POST['Rent_3'] ." _". $_POST['Status_3'] ." ,".
...
$result= " INSERT INTO `wardinfo`( `Ward_name`, `Registrar_Id `, `Supervisor_Id `, `Bed_No_type_rent_Status`) VALUES ('$Ward_name', ' $Registrar_id ','  $Supervisor_id  ', $Bed_No_type_rent_Status')";
